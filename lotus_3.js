...
function setup() {
    ...
    canvasScript = document.getElementById("defaultCanvas0");
    ...
    for(var vao = 0, createdVectors = 0, spectrumPosition = 0; createdVectors <= vetores;  createdVectors++){
        ...
        for(var a = inicio; a <= fim; a *= entremeio){
            ...
            if(contador == 0){
                ...
                stroke(30 , 0, 100);
                drawParticle(-posiX*(a/2) , -posiY*(a/2) , -posiY*(a/3) , -posiX*(a/3) , 30 , 0, 100);
                ...
                stroke(60 , 100 , 100);
                drawParticle((posiX*a)+deslocamento , (posiY*a)+deslocamento , 3+(a/4)*(posiX) , 6+(a/4)*posiY ,50 , 100 , 100);
            }           
            else if(contador == 2){  
                stroke(80 , 100 , 100);
                drawParticle((posiX*a)+deslocamento , 1+(posiY*a)+deslocamento , 5+(a/16)*(posiX/5) , 5+(a/16)*posiY/5 ,100 , 100 , 90);
            }
                
            else if(contador == 3){
                stroke(310 , 80 , 100);
                drawParticle((posiX*a)+deslocamento , (posiY*a)+deslocamento , 3+(a/4)*(posiX) , 6+(a/4)*posiY ,   310 , 55 , 100);
            }   
            else if(contador == 4){
                stroke(270 , 80 , 100);
